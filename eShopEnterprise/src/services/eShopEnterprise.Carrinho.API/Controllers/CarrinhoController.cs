...
namespace eShopEnterprise.Carrinho.API.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        private void ManipularCarrinhoExistente(CarrinhoCliente carrinho, CarrinhoItem item)
        {
            ...
            {
                _context.CarrinhoItem.Update(carrinho.ObterPorProdutoId(item.ProdutoId));
            }
            else
            {
        ...
        private async Task<CarrinhoItem> ObterItemCarrinhoValidado(Guid produtoId, CarrinhoCliente carrinho, CarrinhoItem item = null)
        {
            ...
            var itemCarrinho = await _context.CarrinhoItem.FirstOrDefaultAsync(i => i.CarrinhoId == carrinho.Id && i.ProdutoId == produtoId);
