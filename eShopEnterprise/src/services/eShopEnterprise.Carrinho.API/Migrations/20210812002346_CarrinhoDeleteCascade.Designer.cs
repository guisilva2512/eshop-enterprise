...
namespace eShopEnterprise.Carrinho.API.Migrations
{
    ...
    [Migration("20210812002346_CarrinhoDeleteCascade")]
    partial class CarrinhoDeleteCascade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShopEnterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("eShopEnterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eShopEnterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("eShopEnterprise.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("eShopEnterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("eShopEnterprise.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
